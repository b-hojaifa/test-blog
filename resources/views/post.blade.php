                    ...
                    <div class="main-post">
                        ...
                        <div class="post-icons-area">
                            <ul class="post-icons">
                                ...
                                @else
                                    <a href="#" onclick="document.getElementById('favorite-form-{{ $post->id }}').submit();"><i class="ion-heart"></i>{{ $post->favorite_to_users->count() }}</a>

                                    <form id="favorite-form-{{ $post->id }}" method="POST" action="{{ route('post.favorite', $post->id) }}" style="display: none;"></form>
                                        @csrf
                                        @endguest
                                </li>
                                ...
                                <div class="blog-info">
                                    ...
                                    <ul class="post-footer">
                                        <li>
                                            ...
                                            @else
                                                <a href="#" onclick="document.getElementById('favorite-form-{{ $randompost->id }}').submit();"><i class="ion-heart"></i>{{ $randompost->favorite_to_users->count() }}</a>

                                                <form id="favorite-form-{{ $randompost->id }}" method="POST" action="{{ route('post.favorite', $post->id) }}" style="display: none;"></form>
                                                @csrf
                                            @endguest
                                        </li>
                                        <li><a href="#"><i class="ion-chatbubble"></i>6</a></li>
